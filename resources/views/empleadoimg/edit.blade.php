...
@endsection
@section('content')
<h2 style="margin-top: 12px;" class="text-center">Editar datos empleado </a></h2>
<br>
<form action="{{ route('empleadoimg.update', $empleadoimg_info->id) }}" method="POST" name="update_empleadoimg" enctype="multipart/form-data">
{{ csrf_field() }}
@method('PATCH')
...
<input type="text" name="nombre" class="form-control" placeholder="Enter nombre" value="{{ $empleadoimg_info->nombre }}">
...
<div class="col-md-6">
    ...
    <input type="text" name="apellido" class="form-control" placeholder="Enter apellido" value="{{ $empleadoimg_info->apellido }}">
...
<div class="col-md-6">
    <div class="form-group">
    <strong>ci</strong>
    <input type="text" name="ci" class="form-control" placeholder="Enter ci" value="{{ $empleadoimg_info->ci }}">
...
<div class="col-md-6">
<div class="form-group">
<strong>Foto empleado</strong>
@if($empleadoimg_info->image)
<img id="original" src="{{ url('public/image/'.$empleadoimg_info->image) }}" height="70" width="70">
@endif
<input type="file" name="image" class="form-control" placeholder="" value="{{ $empleadoimg_info->image }}">
